...
export default function NotFound() {
    return (
        ...
        <Text className="">
        <p>findmygift is a marketplace for users to buy and sell gifts(scented candles). findmygift verifies every scented candles to make sure they’re authentic and live up to their product description.</p>
